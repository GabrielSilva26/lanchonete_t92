...
No model manipulamos armazenamos os dados principais da aplicação (cores, formatações, dados do BD).
...
Na View temos os componentes de tela (textos, botões).
    ...
    Sixtaxe de atributo/variáveis
        acesso tipoDeDado nomeAtributo = valor;

    Sintaxe dos Métodos
        acesso retorno NomeDoMétodo( parâmetros )
        {
...
// importamos a classe de tela do Windows para manipular seus componentes
...
namespace Lanchonete_T92
{
    ...
    class LayoutModel
    {
        ...
        public void MontaLogin(Form tela)
        {
            ...
            tela.BackColor = Color.FromArgb( corFundoTelas[0],
                corFundoTelas[1], corFundoTelas[2] );
        }
    }
}
