...
namespace Lanchonete_T92
{
    class DB
    {
        ...
        public void ConectaBanco()
        {
            ...
            {
                // no objeto erro temos todas as mensagens retornadas pelo musql caso encontre haja problema de conexão e deve ser convertido para string para ser escrito no MessageBox()
        ...
        public bool InsereDados(string usuario, string senha )
        {
